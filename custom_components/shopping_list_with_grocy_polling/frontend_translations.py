    ...
    for lang in languages_to_try:
        ...
        if os.path.exists(translation_file):
            try:
                ...
                return translations.get("shopping_list_with_grocy_polling", {})
